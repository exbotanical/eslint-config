...
import { AllOptions, FlatConfigRecord } from '../types'
import { interopDefault, renameRules } from '../utils'
import { GLOB_TS, GLOB_TSX } from '../filepaths'
import { VAR_IGNORE_PATTERN } from '../common'

export interface OptionsTypescript extends AllOptions {
...
export async function typescript(
  ...
  const files = opts.files ?? [GLOB_TS, GLOB_TSX]
  const typeAwareFiles = opts.typeAwareFiles ?? [GLOB_TS, GLOB_TSX]
  ...
  return [
    ...
    ...(isTypeAware
      ? [makeParser(true, typeAwareFiles, typeAwareIgnores)]
      : []),
    {
