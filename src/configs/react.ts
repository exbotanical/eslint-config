...
export interface OptionsReact extends AllOptions {
  filesTypeAware?: string[]
  ignoresTypeAware?: string[]
  tsconfigPath?: string // TODO: shared
}
export async function react({
  ...
  const isAllowConstantExport =
    REACT_REFRESH_ALLOW_CONSTANT_EXPORT_PACKAGES.some(i => isPackageExists(i))
  const isUsingReactRouter = REACT_ROUTER_PACKAGES.some(i => isPackageExists(i))
